...
const MainPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Video Section - Enhanced Mobile Optimization */}
      <div className="relative h-screen min-h-[500px] sm:min-h-[600px] lg:min-h-[700px] overflow-hidden">
        ...
        {/* Hero Content - Enhanced Mobile Optimization */}
        ...
        {/* Call to Action Form - Enhanced Mobile Optimization */}
        <div className="absolute bottom-2 sm:bottom-4 md:bottom-8 lg:bottom-20 left-0 right-0 z-10 flex flex-col items-center w-full px-3 sm:px-6 lg:px-8">
          ...
          >
            <input
              ...
              className="flex-1 min-w-0 shadow-sm rounded-md bg-white h-[40px] sm:h-[44px] lg:h-[42px] px-3 sm:px-4 py-2 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-[#991E1E] focus:ring-opacity-50"
            />
            <input
              type="email"
            ...
            <button
              ...
              className={getButtonClasses("flex-1 lg:flex-none lg:min-w-[180px] xl:min-w-[200px] bg-[#991E1E] text-white px-3 sm:px-4 py-2 font-medium rounded-md shadow-sm hover:bg-[#7a1818] active:bg-[#660c0c] transition-colors flex items-center justify-center h-[40px] sm:h-[44px] lg:h-[42px] text-sm sm:text-base touch-manipulation")}
            >
      ...
      {/* Main Content - Enhanced Mobile Optimization */}
      <div className="py-6 sm:py-8 md:py-12 lg:py-16 xl:py-20">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          {/* Introduction Section */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12 mb-8 sm:mb-12 lg:mb-16">
            <div className="lg:col-span-2 space-y-4 sm:space-y-6 lg:space-y-8">
              <div className="animate-fade-in-up">
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 sm:mb-6 lg:mb-8 leading-tight bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">
                  {t('main.intro.title')}
                </h2>
                
                <div className="prose prose-lg sm:prose-xl text-gray-600 leading-relaxed space-y-4 sm:space-y-6">
                  <p className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed mb-4 sm:mb-6 lg:mb-8 border-l-4 border-[#991E1E] pl-4 sm:pl-6 bg-gradient-to-r from-red-50 to-transparent py-3 sm:py-4">
                  ...
                  <div className="mt-6 sm:mt-8 p-4 sm:p-6 lg:p-8 bg-white rounded-xl border border-gray-200">
                    <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 flex items-center">
                      <svg className="w-4 h-4 sm:w-5 sm:h-5 text-[#991E1E] mr-2" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                      <div className="flex items-center p-3 sm:p-4 bg-gray-50 rounded-lg">
                        <div className="w-6 h-6 sm:w-8 sm:h-8 bg-[#991E1E] rounded-full flex items-center justify-center mr-2 sm:mr-3">
                          <span className="text-white font-medium text-xs sm:text-sm">Қ</span>
                        </div>
                        <div>
                          <h4 className="font-medium text-gray-900 text-xs sm:text-sm">{t('main.sidebar.languages.kazakh.title')}</h4>
                          <p className="text-xs text-gray-500">{t('main.sidebar.languages.kazakh.description')}</p>
                        </div>
                      </div>
                      <div className="flex items-center p-3 sm:p-4 bg-gray-50 rounded-lg">
                        <div className="w-6 h-6 sm:w-8 sm:h-8 bg-[#991E1E] rounded-full flex items-center justify-center mr-2 sm:mr-3">
                          <span className="text-white font-medium text-xs sm:text-sm">Р</span>
                        </div>
                        <div>
                          <h4 className="font-medium text-gray-900 text-xs sm:text-sm">{t('main.sidebar.languages.russian.title')}</h4>
                          <p className="text-xs text-gray-500">{t('main.sidebar.languages.russian.description')}</p>
                        </div>
                      </div>
                      <div className="flex items-center p-3 sm:p-4 bg-gray-50 rounded-lg sm:col-span-2 lg:col-span-1">
                        <div className="w-6 h-6 sm:w-8 sm:h-8 bg-[#991E1E] rounded-full flex items-center justify-center mr-2 sm:mr-3">
                          <span className="text-white font-medium text-xs sm:text-sm">E</span>
                        </div>
                        <div>
                          <h4 className="font-medium text-gray-900 text-xs sm:text-sm">{t('main.sidebar.languages.english.title')}</h4>
            ...
            {/* Sidebar - Enhanced Mobile Optimization */}
            <div className="space-y-4 sm:space-y-6 lg:space-y-8">
              <div className="bg-gray-50 rounded-xl p-4 sm:p-6 lg:p-8 animate-fade-in-up">
                <h3 className="text-base sm:text-lg lg:text-xl font-bold text-gray-900 mb-3 sm:mb-4 lg:mb-6">
                  {t('main.sidebar.quickInfo')}
                </h3>
                <div className="space-y-3 sm:space-y-4">
                  <div>
                    <h4 className="font-semibold text-gray-700 mb-1 sm:mb-2 text-xs sm:text-sm lg:text-base">
                      {t('main.sidebar.phone')}
                    </h4>
                    <a
                      href="tel:+77767083636"
                      className="text-[#991E1E] hover:text-[#7a1818] transition-colors text-xs sm:text-sm lg:text-base"
                    >
                      +7 776 708 3636
                    </a>
                  </div>
                  <div>
                    ...
                    <a
                      ...
                      className="text-[#991E1E] hover:text-[#7a1818] transition-colors text-xs sm:text-sm lg:text-base break-all"
                    >
                      gsb@narxoz.kz
                    </a>
                  </div>
              ...
              <div className="bg-[#991E1E] rounded-xl p-4 sm:p-6 lg:p-8 xl:p-12 text-white text-center animate-fade-in-up">
                <h3 className="text-base sm:text-lg lg:text-xl xl:text-2xl font-bold mb-3 sm:mb-4 lg:mb-6">
                  {t('main.sidebar.quote.title')}
                </h3>
                <p className="text-xs sm:text-sm lg:text-base xl:text-lg leading-relaxed mb-3 sm:mb-4 lg:mb-6 italic">
      ...
      {/* Video Section - Enhanced Mobile Optimization */}
      <div className="py-6 sm:py-8 md:py-12 px-3 sm:px-4 md:px-6 lg:px-8 max-w-7xl mx-auto mb-8 sm:mb-10 lg:mb-12">
        <div className="relative fade-in">
          {/* YouTube Video */}
          <div
            className="relative w-full overflow-hidden rounded-lg sm:rounded-xl shadow-lg"
      ...
      {/* Why Choose Us Section - Enhanced Mobile Optimization */}
      <div className="py-8 sm:py-12 md:py-16 lg:py-20 px-3 sm:px-4 md:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            <h2 className="text-gray-900 text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 slide-in-up">
              {t('main.whyChooseUs.title')}
            </h2>
            <div className="w-16 sm:w-20 lg:w-24 h-1 bg-[#991E1E] mx-auto rounded-full"></div>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {/* Международное признание */}
            <div className="bg-white rounded-lg p-4 sm:p-6 lg:p-8 shadow-sm border border-gray-200 slide-in-up">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-100 rounded-lg flex items-center justify-center mb-4 sm:mb-6">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-[#991E1E]" fill="currentColor" viewBox="0 0 20 20">
                  <path
                    fillRule="evenodd"
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">{t('main.whyChooseUs.internationalRecognition.title')}</h3>
            ...
            {/* Современные подходы */}
            <div
              className="bg-white rounded-lg p-4 sm:p-6 lg:p-8 shadow-sm border border-gray-200 slide-in-up"
            ...
            >
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">{t('main.whyChooseUs.modernApproaches.title')}</h3>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
            ...
            >
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">{t('main.whyChooseUs.practitionerFaculty.title')}</h3>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
            ...
            >
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">{t('main.whyChooseUs.flexibleFormats.title')}</h3>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
            ...
            >
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">{t('main.whyChooseUs.careerSupport.title')}</h3>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
            ...
            >
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">{t('main.whyChooseUs.studentActivity.title')}</h3>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
