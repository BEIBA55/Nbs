    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-screen flex items-end justify-center overflow-hidden pb-20">
        ...
        <div className="relative z-10 text-center text-white px-8 max-w-4xl mx-auto">
          <h1 className="text-5xl lg:text-6xl font-bold mb-6 leading-tight whitespace-nowrap" style={{ transform: 'translateX(-100px)' }}>
          ...
          >
            ...
            <div className="text-left">
              <div className="font-semibold text-lg">{t('executiveSessions.hero.downloadButton')}</div>
            </div>
          </button>
        </div>
      </div>
